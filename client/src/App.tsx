...
const UserDropDown = () => {
  return (
        ...
        return (
          ...
          >
            ...
            <div className="flex items-center">
              ...
              <span className="mr-2 ml-1 text-sm font-semibold">{numberWithCommasEn(1000)}</span>
    ...
    >
      {(toggleDropdown) => (
        <div className="grid w-[157px] p-3.5">
...
export function App() {
  ...
  return (
    <div className="h-screen bg-black/40 bg-[url(./assets/img/bg.png)] bg-cover bg-blend-overlay">
      <div className="fixed inset-0 bg-linear-to-b from-framer-bg/10 to-framer-bg/70" />
      <div className="flex h-full flex-col px-4 pb-11 ">
        ...
        {loading ? <LoadingSpinner /> : <SortedImageGallery images={images} />}
        <div className="mt-auto flex items-center justify-center gap-1 z-20">
          <AppSections />
          <UserDropDown />
        </div>
      </div>
